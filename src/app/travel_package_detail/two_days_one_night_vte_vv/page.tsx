...
export default function VientianeVangViengTour() {
  ...
  // Slideshow images – replace with actual image URLs for Vientiane & Vang Vieng
  const images = [
      ...
      <section className="mb-8">
        ...
        <div className="space-y-6">
          <div>
            ...
            <p className="mt-1">
              Upon arrival in Vientiane, meet your guide and transfer to Vang Vieng via expressway (approx. 1.5 hours).
              In the afternoon, enjoy adventure activities such as hot air balloon or paramotor (optional). Witness the stunning sunset over the limestone mountains.
              Dinner by the Nam Song River and visit the night market.
            </p>
          ...
          <div>
            <h4 className="text-lg font-semibold">DAY 2: Vang Vieng Full Day City Tour (Breakfast, Lunch)</h4>
            <p className="mt-1">
              After breakfast, enjoy outdoor activities including:
            </p>
            <ul className="list-disc list-inside ml-4 mt-1">
              <li>Cave exploration (Nang Fa Cave)</li>
              <li>Kayaking along Nam Song River</li>
            </ul>
            <p className="mt-2">After lunch, return to Vientiane.</p>
        ...
        <div className="bg-blue-50 border-l-4 border-blue-400 p-3 mt-4 text-sm">
          ...
          <ul className="list-disc list-inside space-y-1">
            <li>We will drive new highway road for 1 hour 30 minutes.</li>
            <li>Visitors should dress light and thin cloths during summertime.</li>
            <li>The itinerary can be adjusted due to weather conditions.</li>
          </ul>
        </div>
      </section>
      ...
      <div className="grid md:grid-cols-2 gap-6 mb-8">
        <div className="bg-green-50 p-4 rounded-lg">
          ...
          <ul className="list-disc list-inside space-y-1 text-sm">
            ...
            <li>Full‑day tour in Vang Vieng with lunch</li>
