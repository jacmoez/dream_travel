...
export default function LuangPrabangHeritageEscape() {
  // Slideshow images (real Luang Prabang / Kuang Si / Pak Ou)
  const images = [
  ...
  return (
    <div className="max-w-5xl mx-auto px-4 py-8 font-sans">
      ...
      <div className="bg-gray-50 p-4 rounded-lg mb-6 text-center italic">
        {`Experience the timeless charm of Luang Prabang, where ancient temples, French colonial streets, and natural wonders create the perfect cultural escape.`}
      </div>
      ...
      <div className="grid md:grid-cols-2 gap-4 mb-6">
        ...
        <div className="bg-blue-50 p-3 rounded">
          <span className="font-bold">Destinations Covered:</span> Luang Prabang – Kuang Si – Pak Ou Caves
        </div>
      </div>
      ...
      <section className="mb-8">
        ...
        <ul className="list-disc list-inside space-y-1 ml-4">
          <li>UNESCO Old Town exploration</li>
          <li>Swim at Kuang Si Falls</li>
          <li>Mekong River cruise to Pak Ou Caves</li>
          <li>Optional alms-giving ceremony</li>
        </ul>
      </section>
      ...
      <section className="mb-8">
        ...
        <div className="space-y-4">
          <div>
            <h4 className="text-lg font-semibold">Day 1: Arrival – City Tour</h4>
            <p>Arrival, hotel check-in, visit temples and night market.</p>
          </div>
          <div>
            <h4 className="text-lg font-semibold">Day 2: Kuang Si Waterfall</h4>
            <p>Morning excursion to Kuang Si Falls, free time for swimming and relaxing.</p>
          </div>
          <div>
            <h4 className="text-lg font-semibold">Day 3: Pak Ou Caves – Departure</h4>
            <p>Boat trip along Mekong River to Pak Ou Caves, transfer to airport.</p>
          </div>
        </div>
      </section>
      ...
      <section className="mb-8">
        ...
        <div className="overflow-x-auto">
          <table className="min-w-full border border-gray-300 text-sm">
            ...
            <tbody>
              <tr><td className="border p-2">1</td><td className="border p-2">$320</td></tr>
              <tr><td className="border p-2">2</td><td className="border p-2">$220</td></tr>
              <tr><td className="border p-2">3–4</td><td className="border p-2">$190</td></tr>
              <tr><td className="border p-2">5+</td><td className="border p-2">$170</td></tr>
            </tbody>
          </table>
        </div>
      </section>
      ...
      <section className="mb-8">
        ...
        <ul className="list-disc list-inside space-y-1 ml-4">
          <li>Sunset cruise</li>
          <li>Traditional Baci ceremony</li>
          <li>Luxury hotel upgrade</li>
        </ul>
      </section>
