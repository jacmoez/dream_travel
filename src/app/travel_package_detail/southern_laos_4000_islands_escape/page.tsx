...
export default function SouthernLaos4000IslandsEscape() {
  // Slideshow images (real southern Laos, 4,000 Islands, waterfalls)
  const images = [
  ...
  return (
    <div className="max-w-5xl mx-auto px-4 py-8 font-sans">
      ...
      <div className="bg-gray-50 p-4 rounded-lg mb-6 text-center italic">
        {`Explore the untouched beauty of southern Laos, from waterfalls to island life in Si Phan Don.`}
      </div>
      ...
      <div className="grid md:grid-cols-2 gap-4 mb-6">
        ...
        <div className="bg-blue-50 p-3 rounded">
          <span className="font-bold">Destinations Covered:</span> Pakse – 4,000 Islands – Champasak
        </div>
      </div>
      ...
      <section className="mb-8">
        ...
        <ul className="list-disc list-inside space-y-1 ml-4">
          <li>Visit Khone Phapheng Falls</li>
          <li>Relax on Don Khone Island</li>
          <li>Cycle through local villages</li>
          <li>Explore Mekong islands</li>
        </ul>
      </section>
      ...
      <section className="mb-8">
        ...
        <ul className="list-disc list-inside space-y-2 ml-4">
          <li>Day 1: Arrival Pakse – Bolaven Plateau</li>
          <li>Day 2: Transfer to 4,000 Islands</li>
          <li>Day 3: Island exploration & waterfalls</li>
          <li>Day 4: Return to Pakse – departure</li>
        </ul>
      </section>
      ...
      <section className="mb-8">
        ...
        <div className="overflow-x-auto">
          <table className="min-w-full border border-gray-300 text-sm">
            ...
            <tbody>
              <tr><td className="border p-2">1</td><td className="border p-2">$480</td></tr>
              <tr><td className="border p-2">2</td><td className="border p-2">$350</td></tr>
              <tr><td className="border p-2">3–4</td><td className="border p-2">$310</td></tr>
              <tr><td className="border p-2">5+</td><td className="border p-2">$280</td></tr>
            </tbody>
          </table>
        </div>
      </section>
