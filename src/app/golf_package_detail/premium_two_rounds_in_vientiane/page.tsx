      ...
      <section className="mb-8">
        ...
        <div className="space-y-6">
          <div>
            ...
            <p className="mt-1">
              Upon arrival at Wattay International Airport, you will be met and transferred to your hotel for check‑in. The rest of the day is at your leisure to relax or explore the city.
            </p>
          ...
          <div>
            ...
            <p className="mt-1">
              After breakfast, you will be transferred to Lakeview Golf Club for an 18‑hole round. This scenic course offers a challenging layout with beautiful lake views. Green fees are included. Return transfer to your hotel is provided after your game.
            </p>
          ...
          <div>
            ...
            <p className="mt-1">
              Today you will be taken to Long Vien Golf Club for your second round. The 18‑hole course is known for its peaceful setting and testing water hazards. Green fees are included. After play, return to your hotel.
            </p>
            <p className="mt-1 text-sm text-gray-600"><strong>Meal:</strong> Breakfast</p>
            <p className="text-sm text-gray-600"><strong>Overnight:</strong> Vientiane</p>
          </div>
