...
export default function GolfPackageFourFairways() {
  // Slideshow images – keep as provided (LCC & Lake View images)
  const images = [
    "https://i.imgur.com/rDMj7bS.jpeg",
    "https://i.imgur.com/xosYclE.jpeg",
    "https://i.imgur.com/APhNiLp.jpeg",
    "https://i.imgur.com/VhxhuuU.jpeg",
  ...
  return (
    <div className="max-w-5xl mx-auto px-4 py-8 font-sans">
      <h1 className="text-3xl font-bold text-center mb-2">
        Four Fairways 4 Rounds in Vientiane
      </h1>
      <Slideshow />
      ...
      <div className="grid md:grid-cols-2 gap-4 mb-6">
        <div className="bg-blue-50 p-3 rounded">
          <span className="font-bold">Duration:</span> 6 Days / 5 Nights (4 Rounds)
        </div>
        <div className="bg-blue-50 p-3 rounded">
          <span className="font-bold">Golf Course:</span> Lakeview Club, Vang Vieng Club, Sea Games Club, Long Vien Club
        </div>
      </div>
