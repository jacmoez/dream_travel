...
export default function GolfPackageVientianeMountainsView() {
  // Slideshow images – keep as provided (from Luang Prabang component)
  const images = [
    "https://i.imgur.com/oCWj2un.jpeg",
  ...
  return (
    <div className="max-w-5xl mx-auto px-4 py-8 font-sans">
      <h1 className="text-3xl font-bold text-center mb-2">
        Vientiane &amp; MountainsView 3 Rounds in Vientiane
      </h1>
      <Slideshow />
      ...
      <div className="grid md:grid-cols-2 gap-4 mb-6">
        ...
        <div className="bg-blue-50 p-3 rounded">
          <span className="font-bold">Golf Course:</span> Lakeview Club, Vang Vieng Club, Long Vien Club
        </div>
      </div>
      ...
      <section className="mb-8">
        ...
        <div className="space-y-6">
          <div>
            ...
            <p className="mt-1">
              Upon arrival at Wattay International Airport, you will be greeted and transferred to your hotel for check‑in. The remainder of the day is free for you to relax or explore the capital city.
            </p>
          ...
          <div>
            ...
            <p className="mt-1">
              After breakfast, you will be driven to Lakeview Golf Club for an 18‑hole round. This scenic course offers a challenging layout with beautiful lake views. Green fees are included. Return transfer to your hotel is provided after your game.
            </p>
          ...
          <div>
            ...
            <p className="mt-1">
              Today you will travel to Vang Vieng Golf Club, set amidst stunning limestone karst landscapes. Enjoy an 18‑hole round on this well‑maintained course. Green fees are included. After play, return to your hotel in Vientiane.
            </p>
            <p className="mt-1 text-sm text-gray-600"><strong>Meal:</strong> Breakfast</p>
            <p className="text-sm text-gray-600"><strong>Overnight:</strong> Vientiane</p>
          </div>
          ...
          <div>
            ...
            <p className="mt-1">
              Your final round takes you to Long Vien Golf Club, known for its peaceful setting and testing water hazards. The 18‑hole course promises an enjoyable experience for golfers of all levels. Green fees are included. Return transfer to your hotel is provided.
            </p>
            <p className="mt-1 text-sm text-gray-600"><strong>Meal:</strong> Breakfast</p>
            <p className="text-sm text-gray-600"><strong>Overnight:</strong> Vientiane</p>
          </div>
