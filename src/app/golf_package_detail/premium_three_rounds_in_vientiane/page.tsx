      ...
      <section className="mb-8">
        ...
        <div className="space-y-6">
          <div>
            ...
            <p className="mt-1">
              Upon arrival at Wattay International Airport, you will be welcomed and transferred to your hotel for check‑in. The remainder of the day is free for you to relax or explore Vientiane at your own pace.
            </p>
          ...
          <div>
            ...
            <p className="mt-1">
              After breakfast, you will be transferred to Lakeview Golf Club for an 18‑hole round. This scenic course offers a challenging layout with beautiful lake views. Green fees are included. Return transfer to your hotel will be provided after the game.
            </p>
          ...
          <div>
            ...
            <p className="mt-1">
              Today you will be driven to Sea Games Golf Club, a championship course that hosted the 2009 SEA Games. Enjoy 18 holes on its well‑maintained fairways and greens. Green fees are included. After play, return to your hotel.
            </p>
            <p className="mt-1 text-sm text-gray-600"><strong>Meal:</strong> Breakfast</p>
            <p className="text-sm text-gray-600"><strong>Overnight:</strong> Vientiane</p>
          </div>
          ...
          <div>
            ...
            <p className="mt-1">
              Enjoy breakfast at the hotel before checking out. At the appropriate time, you will be transferred to Wattay International Airport for your departure flight.
            </p>
            <p className="mt-1 text-sm text-gray-600"><strong>Meal:</strong> Breakfast</p>
          </div>
        </div>
