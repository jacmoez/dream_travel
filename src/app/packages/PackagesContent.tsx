...
const GolfTravelPackages: React.FC = () => {
  ...
  const golfPackagesList: Package[] = [
    { name: '4D3N Golf Package – LCC & Lake View', slug: 'four_days_three_nights_lcc_and_lake_view', type: 'golf',duration: '4 Days / 3 Nights', image: 'https://i.imgur.com/gWt7Rav.jpeg',  description: '2 rounds at Long Vien & Lakeview courses. Includes luxury hotel, transfers, and temple tour.' },
    { name: '5D4N Golf Package – LCC, Lake View & SEA Games Course', slug: 'fight_days_four_lcc_and_lake_view_and_sea_game', type: 'golf',duration: '5 Days / 4 Nights', image: 'https://i.imgur.com/pv1D9kn.jpeg',  description: '1 round at Luang Prabang Golf Club + UNESCO city tour & Kuang Si Falls. Riverside hotel.' },
    { name: '5D4N Golf Package – LCC, Lake View & Dansavanh', slug: 'fight_days_four_nights_lcc_and_lake_view_and_dansavanh', type: 'golf',duration: '5 Days / 4 Nights', image: 'https://i.imgur.com/e245TCA.jpeg',  description: '3 rounds at Vang Vieng Golf Resort + hot air balloon, kayaking, and cave exploration.' },
    { name: '5D4N Golf Package – LCC, Lake View & Vang Vieng', slug: 'fight_days_four_nights_lcc_and_lake_view_and_vang_vieng', type: 'golf', duration: '5 Days / 4 Nights',image: 'https://i.imgur.com/JVPhgWk.jpeg', description: '4 rounds + Vat Phou temple tour, Bolaven Plateau coffee visit. Luxury Mekong resort.' },
    { name: '4D3N Golf Package – Luang Prabang (LPQ)', slug: 'four_days_three_nights_laung_prabang', type: 'golf',duration: '4 Days / 3 Nights', image: 'https://i.imgur.com/x3Hi1cE.jpeg',  description: '2 rounds at Long Vien & Lakeview courses. Includes luxury hotel, transfers, and temple tour.' },
    { name: 'Vientiane Golf & Leisure Escape – 7 Days / 6 Nights', slug: 'seven_days_six_nights_laung_prabang_vientiane_leisure_escape', type: 'golf',duration: '4 Days / 3 Nights', image: 'https://i.imgur.com/JUkGbSX.jpeg',  description: '2 rounds at Long Vien & Lakeview courses. Includes luxury hotel, transfers, and temple tour.' },
  ];
